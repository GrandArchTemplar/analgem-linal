...
d = (final_matrix[0][0] + final_matrix[1][1])**2 - 4*(final_matrix[0][1]*final_matrix[1][1] - final_matrix[1][0]*final_matrix[0][1])
l1 = (final_matrix[0][0] + final_matrix[0][1] + math.sqrt(d))/2
l2 = (final_matrix[0][0] + final_matrix[0][1] - math.sqrt(d))/2

print('Внимание! Представляем вам собственные значения!')
print("Значение раз: ", l1)
print("Значение два: ", l2)

if final_matrix[0][0] - l1 != 0:
    x = 1
    y = round(-(final_matrix[0][0] - l1)/final_matrix[0][1], 4)
elif final_matrix[1][1] - l1 != 0:
    x = 1
    y = round(-final_matrix[1][0]/(final_matrix[1][1] - l1), 4)
elif final_matrix[0][0] - l2 != 0:
    x = 1
